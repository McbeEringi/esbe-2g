...
//1が標準,小…暗,大…明
float3 ambient = lerp(lerp(lerp(/*雨*/float3(0.8,0.82,1.0),lerp(lerp(/*夜*/float3(0.7,0.72,0.8),/*昼*/float3(1.57,1.56,1.5),daylight.y),/*日没*/float3(1.7,1.35,0.9),dusk),weather),/*水*/float3(1.0,1.0,0.9),PSInput.wf),/*屋内*/float3(1.2,1.1,1.0),indoor);
...
//ESBE_shadow
float ao = 1.;
if(PSInput.color.g==PSInput.color.b)ao = smoothstep(.48*daylight.y,.52*daylight.y,PSInput.color.g);
